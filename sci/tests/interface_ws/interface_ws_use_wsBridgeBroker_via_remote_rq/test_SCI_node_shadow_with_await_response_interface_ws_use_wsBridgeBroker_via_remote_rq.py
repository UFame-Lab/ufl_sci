...
class SCI_node_test_rLwuhsTzLhUiFoynUdxwigFlJVsdrUHQaFpPJLUha(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
    - `with await response`
    - `"interface": "ws"`
...
class SCI_node_test_BtWKIbLsulTzdTkBbGiWoTeJmooRIHIXIqpPBSjSOHnChIpABNsDwxQwW(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
    - `with await response`
    - `"interface": "ws"`
