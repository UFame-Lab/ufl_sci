...
class SCI_node_test_lqLGnQhOrtyjXKYeAPhZtkQoHxdjkxluknWjpSHriZrR(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
...
class SCI_node_test_RSvwoIZjvPzBVlPXidNBcvmkVtSuUvdDitCTAlBJ(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
    - `without await response`
    - `"interface": "ws"`
