...
class SCI_node_test_qMFltMVDhMHkKzfBMpEDqEAQkNhmImwBUNBRHIoXbWRcMQ(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
...
class SCI_node_test_REmHUoFhbFTErdfSaGQOXxPpROUXVSWVhxhDVN(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
    - `without await response`
    - `"interface": "remote-rq"`
