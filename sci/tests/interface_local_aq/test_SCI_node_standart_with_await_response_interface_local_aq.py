...
class SCI_node_test_jLltcEFgyUwMgDZTZgYGYDICURPfJdqLaKPwHsFN(unittest.TestCase):
    """
    - `"sci_mode": "standart"`
    - `with await response`
    - `"interface": "local-aq"`
    ...
    def setUp(self):
        ...
        sci = SCI(sci_mode="standart", SCI_SETTINGS=SCI_SETTINGS)
    ...
    async def async_test_runner(
        ...
        redis_conn_standart_node = (
            self.sci_core.SCI_SETTINGS.get(
                "local_broker_connection_settings"
            )["redis"]["redis_conn"]
        )
    ...
    def test_qdrwOKJqDAmG(self):
        ...
        """
        msg = self.test_qdrwOKJqDAmG.__doc__
