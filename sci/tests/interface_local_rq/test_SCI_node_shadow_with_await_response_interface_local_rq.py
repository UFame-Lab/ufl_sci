...
class SCI_node_test_VeRWesrhcaQZDDpSfadmmnQZsAkDvLxmUjMnDimcQVdq(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
    - `with await response`
    - `"interface": "local-rq"`
...
class SCI_node_test_cPRjhEZkvWgktjcPhKXXUFAQblgzeIXjUkneNnLVTpwTAPbfC(unittest.TestCase):
    """
    - `"sci_mode": "shadow"`
    - `with await response`
    - `"interface": "local-rq"`
