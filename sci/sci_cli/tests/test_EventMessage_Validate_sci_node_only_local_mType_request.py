...
class EventMessage_Validate_sci_node_only_local_mType_request(unittest.TestCase):
    ...
    def test_EyKVyieRbbDbVrbFMrfeIwXxxhHHugNOH(self):
        """    
        Основные условия:
        - `"sci_mode" - "only_local"`
        - `"mType": "request"`
        ...
        """
        msg = self.test_EyKVyieRbbDbVrbFMrfeIwXxxhHHugNOH.__doc__
        address_section = {
            "interface": "remote-rq",
            "recipient": "appolo_node_aCtn4R2k3qPtziyBEM6EwjdDr7ulRz5WQHDbOZ:generic_test_app",
        }
    ...
    def test_DyKzGOhcHNUPTHDVivgRdXeTJJuHsfxgO(self):
        """    
        Основные условия:
        - `"sci_mode" - "only_local"`
        - `"mType": "request"`
        ...
        """
        msg = self.test_DyKzGOhcHNUPTHDVivgRdXeTJJuHsfxgO.__doc__
        address_section = {
            "interface": "ws",
            "recipient": "appolo_node_aCtn4R2k3qPtziyBEM6EwjdDr7ulRz5WQHDbOZ:generic_test_app",
        }
